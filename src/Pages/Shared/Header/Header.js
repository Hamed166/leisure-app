            ...
            <div className="container mx-auto px-12">
                <div className="w-full flex mx-auto justify-between p-2 ">
                    ...
                    <ul className="nav-list flex flex-row mx-4 text-base">
                       ...
                       { user?.email?<li className="nav-list-item text-gray-900 p-4 uppercase"><NavLink to="/manageBooking">Manage Booking</NavLink></li>:<li className="nav-list-item text-gray-900 p-4  uppercase"><NavLink to="/tours">Tours</NavLink></li>}
                        { user?.email?<li className="nav-list-item text-gray-900 p-4  uppercase"><NavLink to="/mybooking">My Booking</NavLink></li>:<li className="nav-list-item text-indigo-900 p-4 mx-2 uppercase"><NavLink to="/destinations">Destinations</NavLink></li>} 
